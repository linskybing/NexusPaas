...
| /api/v1/plans, /api/v1/queues, /api/v1/accelerator-profiles, /api/v1/network-profiles, /api/v1/placement-profiles, quota/preemption internal APIs | scheduler-quota-service |
...
| /api/v1/storage/*, /api/v1/projects/{id}/storage/*, /api/v1/storage-profiles, /api/v1/admin/user-storage/*, /api/v1/admin/group-storage | storage-service |
| /api/v1/image-requests, /api/v1/images/*, /api/v1/image-acceleration-profiles, /api/v1/image-catalog, /api/v1/projects/{id}/images, /api/v1/harbor-status | image-registry-service |
