...
| PVCProvisioned / StorageBound / StoragePermissionChanged / StorageMountPlanResolved / FastTransferCompleted / LonghornRWXHealthChecked | storage-service | workload, k8s-control, audit-compliance, request-notification, usage-observability | Update mountable volumes, notify users, and publish storage health and mount-plan decision evidence. |
