...
func Spec() platform.ServiceSpec {
	...
	return platform.ServiceSpec{
		...
		Tables:          []string{"storages", "group_storage_permissions", "access_policies", "project_storage_bindings", "storage_profiles", "cache_bindings", "fast_transfer_records", "longhorn_rwx_health", "outbox", "inbox"},
		Events:          []string{"PVCProvisioned", "StorageBound", "ProjectStorageBindingChanged", "ProjectStoragePermissionChanged", "StoragePermissionChanged", "StorageProfileChanged", "StorageMountPlanResolved", "DataPlanePlanBuilt", "CacheBindingChanged", "FastTransferChanged", "FastTransferQueued", "FastTransferProgressed", "FastTransferCompleted", "FastTransferFailed", "LonghornRWXHealthChecked"},
		Routes: []platform.RouteSpec{
			...
			route(http.MethodGet, "/api/v1/projects/{id}/storage/cache-bindings/{cacheBindingId}", "cache_bindings", "get", id("cacheBindingId")),
			route(http.MethodPut, "/api/v1/projects/{id}/storage/cache-bindings/{cacheBindingId}", "cache_bindings", "update", id("cacheBindingId")),
			route(http.MethodDelete, "/api/v1/projects/{id}/storage/cache-bindings/{cacheBindingId}", "cache_bindings", "delete", id("cacheBindingId")),
